...
import { menuItems, reportTasks } from './reportDetailData';

export default function ReportDetailPage() {
  const [sidebarOpen, setSidebarOpen] = useState(false);

  return (
    <div className="ak-report-detail-page">
      ...
      <main className="ak-main">
        <header className="top-header">
          <div className="title-area with-back">
            ...
            <div>
              <h1>Chi tiết báo cáo can thiệp</h1>
              <p>Báo cáo can thiệp <i className="bi bi-chevron-right" /> Chi tiết báo cáo</p>
            </div>
          </div>
        ...
        <section className="detail-card student-card">
          ...
          <div className="plan-info-grid">
            <div><b>Kế hoạch can thiệp</b><span>Kế hoạch can thiệp cá nhân - 01/05/2024</span></div>
            <div><b>Thời gian báo cáo</b><span>01/05/2024 - 07/05/2024</span></div>
            <div><b>Tần suất</b><span>1 tuần/lần</span></div>
            <div><b>Ngày tạo báo cáo</b><span>07/05/2024 - 16:30</span></div>
            <div><b>Giáo viên thực hiện</b><span><img src="https://i.pravatar.cc/40?img=47" alt="teacher" /> Cô Nguyễn Thị An</span></div>
          </div>
        </section>
        ...
        <section className="detail-card task-card">
          ...
          <div className="plan-table">
            <div className="plan-table-head">
              <span>#</span><span>Mục tiêu</span><span>Lĩnh vực</span><span>Mức độ hỗ trợ</span><span>Nội dung can thiệp</span><span>Tổng kết</span>
            </div>
            <div className="plan-table-body">
              {reportTasks.map((item) => <ReportTaskRow key={item.id} item={item} />)}
            </div>
          </div>
        </section>
        ...
        <section className="detail-card summary-card">
          ...
          <p>Trẻ có tiến bộ ở lĩnh vực giao tiếp và vận động tinh. Cần tăng cường hỗ trợ kỹ năng xã hội và duy trì luyện tập các kỹ năng đã đạt được để ổn định và phát triển tiếp.</p>
        </section>
        ...
        <section className="review-grid">
          <div className="detail-card review-card">
            ...
            <p>Báo cáo chi tiết, phản ánh đúng tiến trình của trẻ. Tiếp tục điều chỉnh mức hỗ trợ ở mục tiêu 4 và tăng cường luyện tập thêm.</p>
          </div>
