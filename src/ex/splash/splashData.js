export const loadingSteps = [
  ...
  { id: 2, title: 'Đồng bộ dữ liệu', desc: 'Đang tải... 65%', icon: 'bi-database', tone: 'green', status: 'active' },
  { id: 3, title: 'Kiểm tra thông báo', desc: 'Đang kiểm tra...', icon: 'bi-bell', tone: 'purple', status: 'wait' },
  { id: 4, title: 'Hoàn tất', desc: 'Chờ một chút...', icon: 'bi-check2-circle', tone: 'yellow', status: 'wait' },
];
